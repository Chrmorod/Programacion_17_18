...
public class Juego extends JFrame implements ActionListener{
			...
			public void actionPerformed(ActionEvent arg0) {
				if(numIntro>1){
					...
					if((numAlmacenDado3)==contenido){
						...
						//lblPuntuacion.setText("Puntos:");//pendiente añadir puntos en la clase Jugador.
					}else{
	...
	//Por ultimo cuando llegue a 0 segundo 0 minutos se parara el timer. Y se notificará
	public void logic(){
		try{
			if (timeseg>0){
				Thread.sleep(1000);
